...
#define ROBOT_L_MOTOR_COEF 1 // speed coef for Left motor (default : 1)
#define ROBOT_R_MOTOR_COEF 0.95 // speed coef for Right motor (default : 0.95)

#define ROBOT_SPEED_COEF 0.95 // coefficient on the speed of the robot (default : 0.95)
#define ROBOT_ANGLUAR_SPEED_COEF 0.87 // coefficient on the rotation speed of the robot (default : 0.87)

#define ROBOT_WHEEL_SPACING_M 0.114 // robot space between wheels in m (default : 0.114)
